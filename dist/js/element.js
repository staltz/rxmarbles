...
},{"./fromEvent":10,"@cycle/xstream-adapter":25,"xstream":128}],3:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var fromEvent_1 = require('./fromEvent');
...
},{"./fromEvent":10,"@cycle/xstream-adapter":25,"xstream":128}],4:[function(require,module,exports){
"use strict";
...
},{"@cycle/xstream-adapter":25,"xstream":128}],7:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
...
},{"./BodyDOMSource":2,"./DocumentDOMSource":3,"./ElementFinder":4,"./EventDelegator":5,"./fromEvent":10,"./isolate":14,"./utils":21,"@cycle/xstream-adapter":25,"matches-selector":100,"xstream":128}],8:[function(require,module,exports){
"use strict";
...
},{"xstream":128}],11:[function(require,module,exports){
"use strict";
var hyperscript_1 = require('./hyperscript');
...
},{"./MainDOMSource":7,"./VNodeWrapper":9,"./isolateModule":15,"./modules":19,"./transposition":20,"./utils":21,"@cycle/xstream-adapter":25,"es6-map":68,"snabbdom":121,"xstream":128}],17:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var transposition_1 = require('./transposition');
...
},{"./HTMLSource":6,"./transposition":20,"@cycle/xstream-adapter":25,"snabbdom-to-html":106}],18:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"@cycle/xstream-adapter":25,"xstream":128}],19:[function(require,module,exports){
"use strict";
...
},{"@cycle/xstream-adapter":25,"xstream":128}],21:[function(require,module,exports){
"use strict";
...
},{"rx":102}],24:[function(require,module,exports){
"use strict";
...
},{"xstream":128}],26:[function(require,module,exports){
/*!
...
},{"_process":101}],103:[function(require,module,exports){
'use strict';
...
},{"browser-split":26}],105:[function(require,module,exports){
...
},{"../parse-selector":110,"lodash.escape":91,"lodash.forown":92,"lodash.union":98}],109:[function(require,module,exports){
...
},{"lodash.escape":91,"lodash.forown":92,"lodash.kebabcase":95}],110:[function(require,module,exports){
...
},{"browser-split":26}],111:[function(require,module,exports){
...
},{"symbol-observable":124}],128:[function(require,module,exports){
"use strict";
...
function diagramCompletionComponent(_ref) {
  ...
  var vtree$ = _rx2.default.Observable.combineLatest(time$, isDraggable$, isTall$, style$, isHighlighted$, render);
...
},{"../styles/utils":153,"@cycle/dom":13,"rx":102}],130:[function(require,module,exports){
'use strict';
...
var mouseUp$ = _rx2.default.Observable.fromEvent(document, 'mouseup');
...
function diagramIntent(_ref3) {
  var DOM = _ref3.DOM;
  var click$ = _ref3.click$;

  var marbleMouseDown$ = click$;
  var completionMouseDown$ = DOM.select('.diagramCompletion').events('mousedown');
...
},{"immutable":80,"rx":102}],131:[function(require,module,exports){
'use strict';
...
function makeNewDiagramData$(data$, changeMarbleTime$, changeEndTime$, interactive$) {
  var mod$ = _rx2.default.Observable.merge(changeMarbleTime$.map(function (x) {
  ...
  return data$.flatMapLatest(function (data) {
    return mod$.scan(function (acc, mod) {
      return mod(acc);
    }, data);
...
function diagramModel(props, intent) {
  var data$ = props.data.distinctUntilChanged().shareReplay(1);
  var isInteractive$ = props.interactive.startWith(false);
  var newData$ = makeNewDiagramData$(data$, intent.changeMarbleTime$, intent.changeEndTime$, props.interactive);
  return {
    data$: data$,
    newData$: newData$,
...
},{"rx":102}],132:[function(require,module,exports){
'use strict';
...
function renderMarble(DOM, marbleData$, isDraggable$) {
  var props = _rx2.default.Observable.combineLatest(marbleData$.distinctUntilChanged(), isDraggable$, function (data, isDraggable) {
    return {
      key: 'marble' + data.id,
      data: data,
...
function renderDiagram(DOM, data$, isInteractive$, props) {
  ...
  var marbles = nots.flatMap(function (n) {
    return n;
    ...
    return renderMarble(DOM, group, isInteractive$);
  }).collection({
    latest: {
  ...
  var completions$ = renderCompletion$(DOM, data$, isInteractive$);
  var elements$ = _rx2.default.Observable.combineLatest(completions$, marbles.DOM, function (c, ms) {
    return ms && ms.concat([c]);
  });

  var vtree$ = elements$.map(function (es) {
    return (0, _dom.h)('div', {
      style: diagramStyle,
      attrs: { class: props.class }
    }, [renderDiagramArrow(), renderDiagramArrowHead(), (0, _dom.h)('div', { style: diagramBodyStyle }, es)]);
  });
...
function diagramView(_ref2) {
  ...
  var data$ = animateData$(model.data$).merge(model.newData$);
  var isInteractive$ = model.isInteractive$;
  return renderDiagram(DOM, data$, isInteractive$, props);
}

module.exports = diagramView;

},{"../../rx-collection":148,"../../rx-debug":149,"../../styles/colors":150,"../../styles/dimens":151,"../../styles/fonts":152,"../../styles/utils":153,"../diagram-completion":129,"../marble":134,"@cycle/dom":13,"rx":102}],133:[function(require,module,exports){
'use strict';
...
var _diagramView = require('./diagram-view');

var _diagramView2 = _interopRequireDefault(_diagramView);

var _diagramIntent = require('./diagram-intent');
...
function DiagramComponent(_ref) {
  ...
  var intentSources = {
    DOM: DOM,
    click$: _rx2.default.Observable.defer(function () {
      return view.clicks$;
    })
  };
  var intent = (0, _diagramIntent2.default)(intentSources);
  var model = (0, _diagramModel2.default)(props, intent);
  var view = (0, _diagramView2.default)({ DOM: DOM, model: model, props: props });
...
},{"./diagram-intent":130,"./diagram-model":131,"./diagram-view":132,"@cycle/isolate":22,"rx":102}],134:[function(require,module,exports){
'use strict';
...
function renderSvg(data, isDraggable, inputStyle, isHighlighted) {
  ...
  var color = POSSIBLE_COLORS[data.id % POSSIBLE_COLORS.length];
  return (0, _dom.h)('svg', {
    style: {
      overflow: 'visible',
      width: inputStyle.size,
...
function render(data, isDraggable, inputStyle, isHighlighted) {
  ...
  var vtree = (0, _dom.h)('div.marbleRoot.diagramMarble', {
    style: (0, _utils.mergeStyles)({
      left: data.time + '%',
...
function marbleComponent(_ref) {
  var DOM = _ref.DOM;
  var properties = _ref.props;

  var mouseDown$ = DOM.select('.marbleRoot').events('mousedown');
  var startHighlight$ = DOM.select('.marbleRoot').events('mouseenter');
  var stopHighlight$ = DOM.select('.marbleRoot').events('mouseleave');

  var props = properties.share();
  var data$ = props.pluck('data');
  var isDraggable$ = props.pluck('isDraggable');
  var style$ = props.pluck('style');
  var isHighlighted$ = _rx2.default.Observable.merge(startHighlight$.map(function () {
    return true;
  }), stopHighlight$.map(function () {
    return false;
  })).startWith(false);
  var vtree$ = _rx2.default.Observable.combineLatest(data$, isDraggable$, style$, isHighlighted$, function () {
    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return args;
  }).distinctUntilChanged().map(function (args) {
    return render.apply(undefined, _toConsumableArray(args));
  });

  var end = props.takeLast(1).doOnCompleted(function () {
    return console.log('marble end');
  });
...
},{"../styles/colors":150,"../styles/utils":153,"@cycle/dom":13,"@cycle/isolate":22,"rx":102}],135:[function(require,module,exports){
'use strict';
...
function makeNewInputDiagramsData$(changeInputDiagram$, inputs$) {
  return inputs$.flatMapLatest(function (inputs) {
    return changeInputDiagram$.scan(function (acc, newDiagramData) {
...
},{"./utils":138,"immutable":80,"rx":102}],136:[function(require,module,exports){
'use strict';
...
function makeScheduler() {
  var scheduler = new _rx2.default.VirtualTimeScheduler(0, function (x, y) {
    if (x > y) {
      return 1;
    }
    if (x < y) {
...
function justIncomplete(item, scheduler) {
  return new _rx2.default.AnonymousObservable(function (observer) {
    return scheduler.schedule(null, function () {
...
function toVTStream(diagramData, scheduler) {
  ...
  return _rx2.default.Observable.merge(singleMarbleStreams).takeUntilWithTime(correctedEndTime, scheduler).publish().refCount();
}
...
},{"./utils":138,"immutable":80,"rx":102}],137:[function(require,module,exports){
'use strict';
...
function renderSandbox$(DOM, inputDiagrams$, operatorLabel$, outputDiagram$, width$) {
  var data$ = inputDiagrams$.map(function (data) {
    return data.get('diagrams').map(function (diagram, index) {
      return (0, _diagram2.default)({ DOM: DOM, props: {
          class: 'sandboxInputDiagram',
          key: 'inputDiagram' + index,
          data: _rx2.default.Observable.of(diagram),
  ...
  var inputsVTrees$ = data$.map(_rx2.default.Observable.fromArray).flatMap(function (o) {
    return o.pluck("DOM").toArray().flatMap(function (array) {
      return _rx2.default.Observable.combineLatest(array, function () {
        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
...
function sandboxComponent(_ref) {
  ...
  var changeInputDiagram$ = _rx2.default.Observable.defer(function () {
    return sandbox.data$.flatMap(function (list) {
  ...
  var width$ = props$.map(function (p) {
    return p.width;
  }).startWith('100%');
  var example$ = props$.map(function (p) {
    return p.route;
  }).filter(isTruthy).map(function (key) {
...
},{"../../data/examples":142,"../../styles/colors":150,"../../styles/dimens":151,"../../styles/fonts":152,"../../styles/utils":153,"../diagram/diagram":133,"./sandbox-input":135,"./sandbox-output":136,"@cycle/dom":13,"@cycle/isolate":22,"immutable":80,"rx":102}],138:[function(require,module,exports){
"use strict";
...
},{"rx":102}],140:[function(require,module,exports){
"use strict";
...
exports.default = {
  "combineLatest": {
    ...
    "apply": function apply(inputs) {
      return _rx2.default.Observable.combineLatest(inputs[0], inputs[1], function (x, y) {
        return "" + x.get('content') + y.get('content');
      });
    }
  },
  ...
  "concat": {
    ...
    "apply": function apply(inputs) {
      return _rx2.default.Observable.concat(inputs);
    }
  },
  ...
  "merge": {
    ...
    "apply": function apply(inputs) {
      return _rx2.default.Observable.merge(inputs);
    }
  },
  ...
  "zip": {
    ...
    "inputs": [[{ t: 0, d: 1 }, { t: 20, d: 2 }, { t: 65, d: 3 }, { t: 75, d: 4 }, { t: 92, d: 5 }], [{ t: 10, d: "A" }, { t: 25, d: "B" }, { t: 50, d: "C" }, { t: 57, d: "D" }]],
    "apply": function apply(inputs) {
      return _rx2.default.Observable.zip(inputs[0], inputs[1], function (x, y) {
        return "" + x.get('content') + y.get('content');
      });
    }
  }
...
},{"rx":102}],141:[function(require,module,exports){
"use strict";
...
exports.default = {
  "amb": {
    ...
    "apply": function apply(inputs) {
      return _rx2.default.Observable.amb(inputs);
    }
  }
};

},{"rx":102}],142:[function(require,module,exports){
'use strict';
...
var _transformExamples = require('./transform-examples');

var _transformExamples2 = _interopRequireDefault(_transformExamples);

var _combineExamples = require('./combine-examples');

var _combineExamples2 = _interopRequireDefault(_combineExamples);

var _filterExamples = require('./filter-examples');

var _filterExamples2 = _interopRequireDefault(_filterExamples);

var _mathExamples = require('./math-examples');

var _mathExamples2 = _interopRequireDefault(_mathExamples);

var _booleanExamples = require('./boolean-examples');

var _booleanExamples2 = _interopRequireDefault(_booleanExamples);

var _conditionalExamples = require('./conditional-examples');

var _conditionalExamples2 = _interopRequireDefault(_conditionalExamples);
...
},{"./boolean-examples":139,"./combine-examples":140,"./conditional-examples":141,"./filter-examples":143,"./math-examples":144,"./transform-examples":145}],143:[function(require,module,exports){
"use strict";
...
},{"rx":102}],144:[function(require,module,exports){
"use strict";
...
},{"rx":102}],145:[function(require,module,exports){
"use strict";
...
},{"rx":102}],146:[function(require,module,exports){
'use strict';

var _rxRun = require('@cycle/rx-run');

var _rxRun2 = _interopRequireDefault(_rxRun);
...
SandboxPrototype.createdCallback = function createdCallback() {
  ...
  function main() {
    return {
      DOM: _rx2.default.Observable.just((0, _dom.h)('div', {}, [(0, _dom.h)('x-sandbox', { route: key, key: 1 })]))
    };
  }
  _rxRun2.default.run(main, {
    DOM: (0, _dom.makeDOMDriver)(this, {
      'x-marble': _lib.MarbleComponent,
      'x-diagram-completion': _lib.DiagramCompletionComponent,
      'x-diagram': _lib.DiagramComponent,
      'x-sandbox': _lib.SandboxComponent
    })
  });
};
...
},{"./lib":147,"@cycle/dom":13,"@cycle/rx-run":24,"rx":102}],147:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SandboxComponent = exports.MarbleComponent = exports.DiagramCompletionComponent = exports.DiagramComponent = undefined;

var _sandbox = require('./components/sandbox/sandbox');

var _sandbox2 = _interopRequireDefault(_sandbox);

var _diagram = require('./components/diagram/diagram');

var _diagram2 = _interopRequireDefault(_diagram);

var _marble = require('./components/marble');

var _marble2 = _interopRequireDefault(_marble);

var _diagramCompletion = require('./components/diagram-completion');

var _diagramCompletion2 = _interopRequireDefault(_diagramCompletion);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.DiagramComponent = _diagram2.default;
exports.DiagramCompletionComponent = _diagramCompletion2.default;
exports.MarbleComponent = _marble2.default;
exports.SandboxComponent = _sandbox2.default;

},{"./components/diagram-completion":129,"./components/diagram/diagram":133,"./components/marble":134,"./components/sandbox/sandbox":137}],148:[function(require,module,exports){
'use strict';
...
},{"rx":102}],149:[function(require,module,exports){
'use strict';
...
},{"rx":102}],150:[function(require,module,exports){
'use strict';
...
function renderSvgDropshadow() {
  return (0, _dom.h)('svg', { attrs: { height: '0' } }, [(0, _dom.h)('filter#' + DROPSHADOW_FILTER_ID, { attrs: { height: '130%' } }, [
  // stdDeviation is blur:
  (0, _dom.h)('feGaussianBlur', { attrs: { in: 'SourceAlpha', stdDeviation: '0.05' } }),
  // position relative to marble viewBox:
  (0, _dom.h)('feOffset', { attrs: { dx: '0', dy: '0.05', result: 'offsetblur' } }), (0, _dom.h)('feFlood', { attrs: { 'flood-color': 'rgba(0,0,0,0.4)' } }), (0, _dom.h)('feComposite', { attrs: { in2: 'offsetblur', operator: 'in' } }), (0, _dom.h)('feMerge', [(0, _dom.h)('feMergeNode'), (0, _dom.h)('feMergeNode', { attrs: { in: 'SourceGraphic' } })])])]);
}
